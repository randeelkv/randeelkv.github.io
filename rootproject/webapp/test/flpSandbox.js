		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Randeel K V",
									"targetURL": "#rootrootproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rootrootproject-display": {
								"semanticObject": "rootrootproject",
								"action": "display",
								"description": "Randeel K V Fiori application on Git",
								"title": "Randeel K V",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=root.rootproject",
									"url": sap.ui.require.toUrl("root/rootproject")
								}
							}
						}
					}
